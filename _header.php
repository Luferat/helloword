    ...
    <div id="wrap">
        ...
        <header>
            ...
            <div class="header-search">
                <form action="search.php" method="get" onsubmit="return formSearchValidate('searchHeader')">
                    <input type="search" name="q" id="searchHeader" placeholder="Procurar..." value="<?php echo isset($query) ? $query : '' ?>">
