...
<body>
    ...
    <div id="wrap">
        ...
        <nav>
            ...
            <a id="authNav" href="login.php" title="Logue-se" title="Logue-se">
                <i id="authNavIcon" class="fa-solid fa-right-to-bracket fa-fw"></i>
                <img id="authNavImg" src="" alt="" referrerpolicy="no-referrer">
                <span id="authNavLabel">Login</span>
            </a>
